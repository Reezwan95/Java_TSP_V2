...
private static final double EARTH_RADIUS = 6371;
	...
	public void userEdit()throws NumberFormatException, IOException {
		...
		String newName = Pro4_samireez.jIn.readLine(); //calling bufferedreader object from the main class file
		setName(newName);
		
		//get new lat
		double newLat = Pro4_samireez.getDouble("   latitude: ", -90, 90);
		setLat(newLat);
		
		//get new lon
		double newLon = Pro4_samireez.getDouble("   longitude: ", -180, 180);
		setLon(newLon);
	}
